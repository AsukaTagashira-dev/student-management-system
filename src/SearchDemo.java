...
public class SearchDemo {
    ...
    private static Student createStudent(String id, String name, int age, String email, String major) {
        ...
        return new DemoStudent(id, name, birthDate, email, major);
    }
    ...
    static class DemoStudent extends Student {

        public DemoStudent(String id, String name, LocalDate birthDate,
                           String email, String major) {
            super(id, name, birthDate, email, major, 2023);
        }
